function [raws,s] = ensembl_pep_v45(pepid,species)
...
function [strs,s] = i_getnuc(pepid,sptxt)

	url=sprintf('http://jun2007.archive.ensembl.org/%s/exportview?seq_region_name=&type1=peptide&anchor1=%s&type2=bp&anchor2=&downstream=&upstream=&format=fasta&action=export&_format=Text&options=peptide&options=&output=txt&submit=Continue+%3E%3E',...
	         sptxt,pepid);
